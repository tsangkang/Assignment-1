...
bool CreateMainWindow(HWND &hwnd, HINSTANCE hInstance, int nCmdShow)
{
	...
	// Fill in the window class structure with parameters that describes the main window
	...
	hwnd = CreateWindow(
		...
		GAME_HEIGHT,		// height of the windw
...
LRESULT WINAPI WinProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_DESTROY:
		...
		//		int y = rand() % 255;
		//		int z = rand() % 255;
		//		graphics->setBackColor(D3DCOLOR_XRGB(x, y, z));
		//		return 0;
		//	}
	}
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPreyInstance, LPSTR lpCmdLine, int nCmdShow)
{
