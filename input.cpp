...
void Input::initialize(HWND hwnd, bool capture)
{
	try {
		...
		checkControllers();			// check for connected controlers
	}
	catch (...)
	{
...
//===================================================================
// Set true in the keysDown and keysPressed array for this key
// Pre: wPAram contains the virtual key code (0 - 255)
//===================================================================
void Input::keyDown(WPARAM wParam)
{
	// make sure ky code is within buffer range
...
void Input::keyIn(WPARAM wParam)
{
	...
	{
		if (textIn.length() > 0)				// if characters exists
...
//======================================================================================
// Returns true if the specified VIRTUAL KEY has been pressed in the most recent
