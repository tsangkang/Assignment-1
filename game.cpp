...
{
	// test for and ahndle lost device
	...
	if (FAILED(hr))			// if graphics device is not in a valid state
	{
		...
		// device was lost but is now available for reset
...
void Game::renderGame()
{
	...
	{
		// render is a pure virtual function that must be provided in the inheirting class
