...
#ifndef _OBSTACLES_UD_H               // Prevent multiple definitions if this 
#define _OSBTACLES_UD_H               // file is included in more than one place
#define WIN32_LEAN_AND_MEAN

#include "entity.h"
#include "constants.h"

namespace obstaclesUDNS
{
...
class ObstaclesUD : public Entity            // inherits from Entity class
{
private:
	Image obstacle;
